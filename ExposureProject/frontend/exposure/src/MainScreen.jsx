...
export default function MainScreen() {
  ...
  return (
    <div className="main-screen">
      <h1 className="main-screen__title">Кто лжёт?</h1>
      <p className="main-screen__subtitle">
        Выберите двух противников ({selectedBotIds.length}/2)
      </p>
      ...
      {botsReady && (
        <div className="main-screen__missions-wrap">
          <p className="main-screen__missions-label">Выберите миссию</p>
          {missions.length === 0 ? (
            <p className="main-screen__missions-empty">Нет доступных миссий</p>
          ) : (
